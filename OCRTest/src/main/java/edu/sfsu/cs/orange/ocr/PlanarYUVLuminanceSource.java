...
public final class PlanarYUVLuminanceSource extends LuminanceSource {
  ...
  public Bitmap renderCroppedGreyscaleBitmap() {
    ...
    int i = 0;
    for (byte datum : yuvData) {
      int grey = datum & 0xff;
      pixels[i] = 0xFF000000 | (grey * 0x00010101);
      i++;
    }
    Bitmap bitmap = Bitmap.createBitmap( dataHeight, dataWidth,Bitmap.Config.ARGB_8888);
    bitmap.setPixels(pixels, 0, dataHeight, 0, 0, dataHeight, dataWidth);
    return cropBitmap(getRotateBitmap(bitmap));
  }
  ...
  private Bitmap cropBitmap(Bitmap bitmap) {
    return Bitmap.createBitmap(bitmap, left,top, getWidth(), getHeight(), null, false);
  }
