...
public final class ViewfinderView extends View {
   ...
   * @param attrs
   */
  private void initFinderRect(Context context, AttributeSet attrs) {
    //获取屏幕参数
    ...
    float margintTop = typedArray.getDimension(R.styleable.ViewfinderView_finderMarginTop, 0);
    float width = typedArray.getDimension(R.styleable.ViewfinderView_finderWidth, 0);
    float height = typedArray.getDimension(R.styleable.ViewfinderView_finderHeight, 0);
    mFinderRect = new Rect((displayPoint.x-(int)width)/2, (int)margintTop, (int)(displayPoint.x + width)/2, (int)(margintTop + height));
  }
