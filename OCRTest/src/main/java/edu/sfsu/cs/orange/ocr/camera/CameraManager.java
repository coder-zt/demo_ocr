...
public final class CameraManager {
  ...
  public CameraManager(Context context, CaptureActivity activity) {
    ...
    previewCallback = new PreviewCallback(configManager, activity);
  }
...
//    }
  ...
  public synchronized Rect getFramingRectInPreview() {
    if (framingRectInPreview == null) {
      ...
      Log.d(TAG, "getFramingRectInPreview:" + String.format("屏幕中的范围：start point:(%d,%d)--->size:(%d,%d)", rect.left,rect.top,rect.width(),rect.height()));

      Point cameraResolution = configManager.getCameraResolution();
      Point screenResolution = configManager.getScreenResolution();
      Log.d(TAG, "getFramingRectInPreview: 相机分辨率参数" + cameraResolution);
      Log.d(TAG, "getFramingRectInPreview: 屏幕分辨率参数" + screenResolution);
      ...
      Log.d(TAG, "getFramingRectInPreview:" + String.format("映射到bitmap中：start point:(%d,%d)--->size:(%d,%d)", rect.left,rect.top,rect.width(),rect.height()));
  ...
  public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
    ...
    Log.d(TAG, "buildLuminanceSource: start point:(" + rect.left + "," + rect.top + ")--->width=" + rect.width() + "----height=" + rect.height());
    return new PlanarYUVLuminanceSource(data, width, height, rect.left, rect.top,
                                        rect.width(), rect.height(), reverseImage);
  }

  public void setFinderRect(Rect finderRect) {
    framingRect = finderRect;
  }
}
